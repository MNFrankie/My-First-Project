...
<script src="../include/WebResource.js" type="text/javascript"></script>
    ...
    <div class="header">
            ...
            <div class="loginDisplay">&quot;Cosmetics&quot;</div>
	...
	<ul role="menubar" style="position: relative; width: auto; float: left;" tabindex="0" class="level1 static">
		...
		<li style="position: relative; float: left;" class="static" role="menuitem"><a tabindex="-1" class="level1 static" href="../portal.php">Portal</a></li><li style="position: relative; float: left;" class="static" role="menuitem"><a tabindex="-1" class="level1 static" href="log_out.php">Log Out</a></li>
	</ul>
...
<table width="100%" height="220" border="1">
  <tr bgcolor="#00CCFF">
    <th width="45%" height="31" scope="col"><h2 align="left">INPUT</h2></th>
    <th width="55%" scope="col"><h2 align="left">OUTPUT</h2></th>
  </tr>
  <tr>
    <td><ol>
      <li><a href="admit_student.php">Admit A Student</a></li><br />
      <li><a href="entermarks.php">Enter Student Exam Marks<br />
      </a></li>
    </ol></td>
    <td><ol>
      <li><a href="display_comments.php">View Website visitors Comments</a><br /><br /></li>
      <li><a href="display_marks.php">View Students Marks</a></li><br />
      <li><a href="display_students_info.php">View Students Information</a></li>
    </ol></td>
  </tr>
</table>
<p>&nbsp;
