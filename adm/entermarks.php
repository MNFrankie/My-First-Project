...
<script src="../include/WebResource.js" type="text/javascript"></script>
	...
	<ul role="menubar" style="position: relative; width: auto; float: left;" tabindex="0" class="level1 static">
      ...
      <form id="form1" name="form1" method="post" action="entermarks_codes.php">
      <table width="100%">
  <tr>
    <th width="80%" height="232" scope="col"><h2 align="left">Enter Student Marks By Filling . . .</h2><table width="100%" border="1">
      <tr>        </tr>
    </table>
      <table width="100%" border="1">
        <tr align="left" bgcolor="#CCCCCC">
          <th width="44%" scope="col">Student No.</th>
          <th width="37%" scope="col">&nbsp;</th>
          </tr>
        <tr align="left">
          <td><span id="sprytextfield1">
          <label for="student_no"></label>
          <input name="student_no" type="text" id="student_no" size="4" />
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "integer", {hint:"0001"});
