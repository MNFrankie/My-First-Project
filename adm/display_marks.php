...
<script src="../include/WebResource.js" type="text/javascript"></script>
	...
	<ul role="menubar" style="position: relative; width: auto; float: left;" tabindex="0" class="level1 static">
      ...
      <table width="100%">
  <tr>
    <th width="80%" height="232" scope="col"><?php
	include ('db_connect.php');
	
	$result=mysql_query("SELECT * FROM marks");
		//echo "Today is ".(date("Y-m-d",time())). "<br/><br/>";
		echo "<br/><br/>";
		echo "<h2 align='left'>This are the student marks</h2>";
		echo "<table width='100%'  cellpadding='8' cellspacing='0' border='1'>";
		echo "<tr bgcolor='00FFFF'><th align=left>No.</th><th>Student No.</th><th>First Name</th><th>Form</th><th>Stream</th><th>English</th><th>Maths</th><th>Kiswahili</th></tr>";	
	while ($row=mysql_fetch_array($result))
	{
					echo " <tr><td align=left>";
			 		echo  $row['id'];// display date
			 		echo  "</td>
			 		<td align=left>";
			 		echo  $row['student_no'];// flourkgs
			  		echo "</td>
			  		<td align=left>";
					echo $row['fname'];// flourshs
					echo  "</td> 
			  		<td align=left> ";  
					echo $row['form']; // sugarkgs
					echo "</td>
					<td align=left>";
					echo $row['stream'];//sugarshs
					echo "</td>";
					echo "</td>
					<td align=left>";
					echo $row['english'];//sugarshs
					echo "</td>";
					echo "</td>
					<td align=left>";
					echo $row['maths'];//sugarshs
					echo "</td>";
					echo "</td>
					<td align=left>";
					echo $row['kiswahili'];//sugarshs
					echo "</td>";
            		echo " </tr>";
		}
    ?>&nbsp;</th>
...
<table width="100%">
  <tr>
    <th width="22%" scope="col" bgcolor="">&nbsp;</th>
  </tr>
</table>
