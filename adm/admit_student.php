...
<script src="../include/WebResource.js" type="text/javascript"></script>
	...
	<ul role="menubar" style="position: relative; width: auto; float: left;" tabindex="0" class="level1 static">
      ...
      <form id="form1" name="form1" method="post" action="admit_student_codes.php">
      <table width="100%">
  <tr>
    <th width="84%" height="232" scope="col"><h2 align="left">Student Admission, please fill . . .</h2>
      ...
      <table width="100%" border="1">
        <tr bgcolor="#CCCCCC">
          <th width="23%" scope="col" >Student Information</th>
        ...
        <tr align="left">
          ...
          <td><span id="sprytextfield9">
            <label for="kcpe"></label>
            <input type="text" name="kcpe" id="kcpe" />
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          <td>&nbsp;</td>
        </tr>
        <tr bgcolor="#CCCCCC">
          <td>Parents Information</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        ...
        <tr align="left">
          <td><span id="sprytextfield4">
            <label for="parentfname"></label>
            <input type="text" name="parentfname" id="parentfname" />
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          ...
          <td><span id="sprytextfield6">
            <label for="parentmobile"></label>
            <input type="text" name="parentmobile" id="parentmobile" />
            <span class="textfieldRequiredMsg">A value is required.</span></span></td>
          <td><label for="nationalid"></label>
            <input type="text" name="nationalid" id="nationalid" /></td>
        </tr>
        <tr align="left">
          <td>Address Home</td>
          <td>County</td>
        ...
        <tr>
          ...
          <td><span id="spryselect5">
            <label for="primarycounty"></label>
            <select name="primarycounty" id="primarycounty">
              <option>Nyeri</option>
              <option>Nairobi</option>
            ...
            <span class="selectRequiredMsg">Please select an item.</span></span></td>
          <td><label for="primaryaddress"></label>
            <input type="text" name="primaryaddress" id="primaryaddress" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr align="left">
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><label for="primaryaddress"></label></td>
