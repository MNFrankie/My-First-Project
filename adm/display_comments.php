...
<script src="../include/WebResource.js" type="text/javascript"></script>
  ...
  <tr>
	...
	$result=mysql_query("SELECT * FROM comments");
		...
		echo "<br/><br/>";
		echo "<h2>This are the comments from various customers</h2>";
		echo "<table width='100%'  cellpadding='8' cellspacing='0' border='1'>";
		echo "<tr bgcolor='00FFFF'><th align=left>No.</th><th>Date</th><th>Name</th><th>email</th><th>Comments</th></tr>";	
	while ($row=mysql_fetch_array($result))
	{
					echo " <tr><td align=left>";
			 		...
			 		echo  "</td>
			 		<td align=left>";
			 		echo  date("Y-m-d",time());// flourkgs
			  		echo "</td>
			  		<td align=left>";
					echo $row['name'];// flourshs
					echo  "</td> 
			  		<td align=left> ";  
					echo $row['email']; // sugarkgs
					echo "</td>
					<td align=left>";
					echo $row['comment'];//sugarshs
					echo "</td>";
            		echo " </tr>";
		}
    ?>&nbsp;</th>
