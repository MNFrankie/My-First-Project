...
<script src="../include/WebResource.js" type="text/javascript"></script>
  ...
  <tr>
	...
	$result=mysql_query("SELECT * FROM admission");
		...
		echo "<br/><br/>";
		echo "<h2>This are the admitted students information </h2>";
		echo "<table width='100%'  cellpadding='8' cellspacing='0' border='1'>";
		echo "<tr bgcolor='00FFFF'><th align=left>Admission</th><th>Date of Admission</th><th>First Name</th><th>Second Name</th><th>Home County</th></tr>";	
	while ($row=mysql_fetch_array($result))
	{
					echo " <tr><td align=left>";
			 		...
			 		echo  "</td>
			 		<td align=left>";
			 		echo  $row['date'];// flourkgs
			  		echo "</td>
			  		<td align=left>";
					echo $row['fname'];// flourshs
					echo  "</td> 
			  		<td align=left> ";  
					echo $row['sname']; // sugarkgs
					echo "</td>
					<td align=left>";
					echo $row['county'];//sugarshs
					echo "</td>";
            		echo " </tr>";
		}
    ?>&nbsp;</th>
